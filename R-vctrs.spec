...
Version  : 0.2.0
Release  : 6
URL      : https://cran.r-project.org/src/contrib/vctrs_0.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vctrs_0.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562520169
