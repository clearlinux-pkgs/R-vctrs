...
Version  : 0.3.3
Release  : 19
URL      : https://cran.r-project.org/src/contrib/vctrs_0.3.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vctrs_0.3.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598642743
