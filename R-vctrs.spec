...
Version  : 0.2.3
Release  : 10
URL      : https://cran.r-project.org/src/contrib/vctrs_0.2.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vctrs_0.2.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582304992
